...
const storewatchVendorMap = {
    ...
    '春季特卖（SPRING SALE）': '优惠活动',
    '刺客信条:幻景（Assassin\'s Creed Mirage）': '育碧',
    '刺客信条:影（Assassin\'s Creed Shadows）': '育碧',
    '刀剑神域:碎梦边境（Sword Art Online: Fractured Daydream）': 'Bandai Namco',
    ...
    '雷曼:30 周年纪念版（Rayman 30th Anniversary Edition）': '育碧',
    ...
    '杀手:暗杀世界（HITMAN World of Assassination）': 'IO Interactive A/S',
    ...
    '异环（Neverness To Everness）': '完美世界',
    '逸剑风云决（Wandering Sword）': '侠萌游戏',
    '英灵乱战（BrawIhalla）': '育碧',
    '勇者斗恶龙10（Dragon Warrior X）': 'Square Enix',
    '勇者斗恶龙Ⅰ&Ⅱ:HD-2D重制版（DRAGON QUEST I & IIHD-2D Remake）': 'Square Enix',
    '勇者斗恶龙Ⅶ Reimagined（Dragon Quest VII: Reimagined）': 'Square Enix',
    '幽冥行动:断点（Tom Clancy\'s Ghost Recon Breakpoint）': '育碧',
    '宇宙机器人（Astro Bot）': '索尼',
    ...
    '最佳伙伴游戏专题（BEST COMPANIONS）': '游戏专题',
    '最受期待游戏专题（MOST ANTICIPATED）': '游戏专题',
    ...
    PS5: [
        ...
        { date: '2026-05-08', slots: {
            'Must See': { positions: [
                ...
                { rank: 4, us: '女性主角游戏专题（AMAZING HEROINES）', jp: '人气经典游戏', hk: '女性主角游戏专题（AMAZING HEROINES）' },
        ...
        { date: '2026-05-06', slots: {
            'Must See': { positions: [
                ...
                { rank: 6, us: '格斗游戏专题（FIGHTING GAMES）', jp: '人气经典游戏', hk: '最受期待游戏专题（MOST ANTICIPATED）', vendor: '游戏专题' },
            ] },
            'Top games in your country': { positions: [
    ...
    Xbox: [
        { date: '2026-05-11', slots: {
            ...
            'Game Home-banner': { positions: [
                ...
                { rank: 2, us: '每周精选（Weekly selects）', jp: '每周精选（Weekly selects）', hk: '每周精选（Weekly selects）' },
            ] },
            ...
            'Store Home-banner': { positions: [
                ...
                { rank: 2, us: '优质新游戏（Great New Games）', jp: '优质新游戏（Great New Games）', hk: '优质新游戏（Great New Games）' },
        ...
        { date: '2026-05-09', slots: {
            'Dash home-banner': { positions: [
                ...
                { rank: 3, us: 'Islander Heritage Month', jp: 'Xbox Play Anywhere', hk: '超省钱特卖（Super Saver Sale）' },
            ] },
            'Dash home-banner2': { positions: [
            ...
            'Game Home-hero banner': { positions: [
                { rank: 1, us: 'Xbox Play Anywhere', jp: 'Xbox Play Anywhere', hk: 'Xbox Play Anywhere' },
            ] },
            'Store Home-banner': { positions: [
