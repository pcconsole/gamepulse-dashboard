...
const storewatchMeta = {
    ...
    dataRange: '2025-12-19 ~ 2026-04-02',
...
const storewatchGameNameMap = {
    ...
    '巅峰守卫': 'Highguard',
    '动视发行商特卖': 'Activision',
    '动作冒险游戏促销活动': 'Action Adventure sale',
    ...
    'Action Adventure sale': '动作冒险游戏促销活动',
    'Activision': '动视发行商特卖',
...
// 最后更新：2026-04-02
// 数据范围：2025-12-19 ~ 2026-04-02
const storewatchData = {
    PS5: [
        { date: '2026-04-02', slots: {
            'Must See': { positions: [
                { rank: 1, us: '使命召唤:黑色行动7（Call of Duty: Black Ops 7）', jp: '春季特卖（SPRING SALE）', hk: '春季特卖（SPRING SALE）', vendor: '微软' },
                { rank: 2, us: '侠盗猎车手6（Grand Theft Auto VI）', jp: '漫威金刚狼（Marvel\'s Wolverine）', hk: '漫威金刚狼（Marvel\'s Wolverine）', vendor: 'Take-Two' },
                { rank: 3, us: '绝区零（Zenless Zone Zero）', jp: '堡垒之夜（Fortnite）', hk: '红色沙漠（Crimson Desert）', vendor: '米哈游' },
                { rank: 4, us: '复古经典游戏专题', jp: 'NBA 2K26', hk: 'PS5必玩游戏', vendor: 'Take-Two' },
                { rank: 5, us: '堡垒之夜（Fortnite）', jp: '每月精选游戏', hk: 'PS5专享升级（UPGRADED FOR PS5）', vendor: 'Epic' },
                { rank: 6, us: '雷曼:30 周年纪念版（Rayman 30th Anniversary Edition）', jp: '2026绝佳游戏（2026 GREAT GAMES）', hk: '战神:斯巴达之子（God of War: Sons of Sparta）', vendor: '索尼' },
            ] },
            ...
            "What's hot": { positions: [
                { rank: 1, us: '无限暖暖（Infinity Nikki）', jp: '航海王:海贼无双4（One Piece: Pirate Warriors 4）', hk: '怪物猎人:荒野（Monster Hunter Wilds）', vendor: '叠纸游戏' },
                { rank: 2, us: '全境封锁2（Tom Clancy\'s The Division 2）', jp: '侠盗猎车手5（Grand Theft Auto V）', hk: '羊蹄山之魂（Ghost of Yōtei）', vendor: 'Take-Two' },
                { rank: 3, us: '零红蝶', jp: 'LGBTQIA+游戏专题', hk: '怪物猎人:荒野（Monster Hunter Wilds）', vendor: 'KOEI TECMO' },
                { rank: 4, us: 'Apex英雄（Apex Legends）', jp: '侠盗猎车手6（Grand Theft Auto VI）', hk: 'PS5必玩游戏', vendor: 'EA' },
                { rank: 5, us: 'Roguelike游戏专题', jp: '我的世界（Minecraft）', hk: '识质存在（Pragmata）', vendor: '微软' },
    ...
    Xbox: [
        { date: '2026-04-02', slots: {
            'Dash home-banner': { positions: [
                { rank: 1, us: '春季特卖（SPRING SALE）', jp: '春季特卖（SPRING SALE）', hk: 'Xbox Partner Preview', isNonGame: true },
                { rank: 2, us: 'Xbox Partner Preview', jp: 'Game Pass 会员优惠', hk: 'Alien Deathstorm' },
                { rank: 3, us: 'Apex英雄（Apex Legends）', jp: 'Xbox Partner Preview', hk: '春季特卖（SPRING SALE）', vendor: 'EA' },
            ] },
        ...
        { date: '2026-04-01', slots: {
            'Dash home-banner': { positions: [
                { rank: 1, us: 'Xbox Partner Preview', jp: 'Game Pass 会员优惠', hk: 'Xbox Partner Preview', isNonGame: true },
                { rank: 2, us: '奇异人生:重聚（Life is Strange: Reunion）', jp: 'Xbox Partner Preview', hk: '奇异人生:重聚（Life is Strange: Reunion）', vendor: 'Square Enix' },
                { rank: 3, us: '堡垒之夜（Fortnite）', jp: '奇异人生:重聚（Life is Strange: Reunion）', hk: 'Alien Deathstorm', vendor: 'Epic' },
            ] },
            'Dash home-banner2': { positions: [
            ...
            'Game Home-banner': { positions: [
                ...
                { rank: 2, us: '美国职业棒球大联盟26（MLB The Show 26）', jp: '奇异人生:重聚（Life is Strange: Reunion）', hk: '美国职业棒球大联盟26（MLB The Show 26）', vendor: '索尼' },
            ] },
            'Game Home-hero banner': { positions: [
                { rank: 1, us: '失落星船:马拉松（Marathon）', jp: '失落星船:马拉松（Marathon）', hk: '失落星船:马拉松（Marathon）', vendor: '索尼' },
            ] },
            'Store Home-banner': { positions: [
                ...
                { rank: 3, us: '红色沙漠（Crimson Desert）', jp: '红色沙漠（Crimson Desert）', hk: '红色沙漠（Crimson Desert）', vendor: 'Pearl Abyss' },
        ...
        { date: '2026-03-31', slots: {
            'Dash home-banner': { positions: [
                { rank: 1, us: '战地风云6（Battlefield 6）', jp: 'Game Pass 会员优惠', hk: 'Xbox Partner Preview', vendor: 'EA' },
                { rank: 2, us: 'Xbox Partner Preview', jp: 'Xbox Partner Preview', hk: '奇异人生:重聚（Life is Strange: Reunion）', vendor: 'Square Enix' },
                { rank: 3, us: '堡垒之夜（Fortnite）', jp: '奇异人生:重聚（Life is Strange: Reunion）', hk: '动作冒险游戏促销活动（Action Adventure sale）', vendor: 'Epic' },
            ] },
            'Dash home-banner2': { positions: [
            ...
            'Game Home-banner': { positions: [
                { rank: 1, us: '红色沙漠（Crimson Desert）', jp: '怪物猎人物语3:命运双龙（Monster Hunter Stories 3: TWISTED REFLECTION）', hk: '怪物猎人物语3:命运双龙（Monster Hunter Stories 3: TWISTED REFLECTION）', vendor: 'Pearl Abyss' },
                { rank: 2, us: '奇异人生:重聚（Life is Strange: Reunion）', jp: '战地风云6（Battlefield 6）', hk: '战地风云6（Battlefield 6）', vendor: 'Square Enix' },
            ] },
            'Game Home-hero banner': { positions: [
                { rank: 1, us: '战地风云6（Battlefield 6）', jp: '红色沙漠（Crimson Desert）', hk: '红色沙漠（Crimson Desert）', vendor: 'EA' },
            ] },
            'Store Home-banner': { positions: [
        ...
        { date: '2026-03-30', slots: {
            ...
            'Store Home-banner': { positions: [
                ...
                { rank: 3, us: '动作冒险游戏促销活动（Action Adventure sale）', jp: '战地风云6（Battlefield 6）', hk: '战地风云6（Battlefield 6）', vendor: 'EA' },
                { rank: 4, us: '趋势游戏（Trending）', jp: '趋势游戏（Trending）', hk: '趋势游戏（Trending）', isNonGame: true },
            ] },
            'Store Home-hero banner': { positions: [
        ...
        { date: '2026-03-27', slots: {
            'Dash home-banner': { positions: [
                { rank: 1, us: 'Xbox Partner Preview', jp: 'Xbox Partner Preview', hk: 'Xbox Partner Preview', isNonGame: true },
                { rank: 2, us: '堡垒之夜（Fortnite）', jp: 'Game Pass 会员优惠', hk: '奇异人生:重聚（Life is Strange: Reunion）', vendor: 'Epic' },
                { rank: 3, us: 'XBOX性能最佳化', jp: '奇异人生:重聚（Life is Strange: Reunion）', hk: '动作冒险游戏促销活动（Action Adventure sale）', vendor: 'Square Enix' },
            ] },
            'Dash home-banner2': { positions: [
            ...
            'Store Home-banner': { positions: [
                ...
                { rank: 3, us: '微软模拟飞行2024（Microsoft Flight Simulator 2024）', jp: '战地风云6（Battlefield 6）', hk: '战地风云6（Battlefield 6）', vendor: '微软' },
                { rank: 4, us: '趋势游戏（Trending）', jp: '趋势游戏（Trending）', hk: '趋势游戏（Trending）', isNonGame: true },
            ] },
            'Store Home-hero banner': { positions: [
                { rank: 1, us: '奇异人生:重聚（Life is Strange: Reunion）', jp: '奇异人生:重聚（Life is Strange: Reunion）', hk: '奇异人生:重聚（Life is Strange: Reunion）', vendor: 'Square Enix' },
