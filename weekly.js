...
window.WEEKLY_REPORTS = [
  {
    ...
    title: '端主行业周报 W35：同处主机末期·索尼收租Xbox铺内容·TGS存量IP大年·订阅涨价反噬',
    summary: '承接 W33"索尼硬件进入末期、转向收租"——同处世代末期，Xbox 走另一条路：把增长押在"内容触达面+订阅"而非卖主机，本周三条动作串成完整链路：拿内容（接盘索尼弃子小岛《PHYSINT》确认比尔·斯卡斯加德主角配音 + 暴雪嘉年华公布暗黑5(2029)/星际(2030)远期第一方）、铺渠道（大作 GP 首发 + Play Anywhere 跨端，买不买 Xbox 主机都能玩）、划边界（战网逐步引入第三方但明确不做 Steam/Epic 式开放商店）。TGS 2026（30周年、史上首次5天、近30万访客）是存量 IP 大年、缺新 IP 爆款：满分《火焰纹章:万缕千丝》IGN 10分为 NS2 独占、最高分《空之轨迹 the 2nd》93分是20年前重制；SE 本届最大阵容，索尼把发布会前置到9/3 State of Play、会期内以4款展台试玩参与。订阅涨价开始反噬：Circana 数据显示美国退订首因从"没游戏"转向"太贵"（40%+，退订 Switch Online 者达50%），涨价边际收益见顶。',
    file: 'weekly/W35_20260918.html',
    tags: ['Xbox铺内容+订阅', 'TGS存量IP大年', '订阅涨价反噬', '退订转向价格', '小岛PHYSINT主演'],
    highlight: true
  },
  {
    week: 'W34',
    ...
    title: '端主行业周报 W34：数字化系统性风险坐实·索尼砍第一方Xbox反攻·任天堂内容轰炸资本冷淡·Steam长尾长销',
    summary: '数字所有权之争本周换了层次——从"索尼vs微软路线之争"下沉到"纯数字化模式自身的风险"，三个独立事件同周引爆三类结构性缺陷：授权（Switch 2大批正版玩家被误封锁死，码2124-4508，eShop/已购下载/卡带全不可用）、区域覆盖（索尼宣布2028/1停产新游实体光盘全面数字化，但超60%国家约121国无法注册PSN）、发行商协同（微软"光盘转数字"遭SE/世嘉/万代集体缺席，《最终幻想》《艾尔登法环》无法兑换，仅育碧9/9加入）——实体退场从平台选择题坐实为全行业系统性风险。独占内容攻守易位：承接W33"索尼从卖硬件转向收租"，本周代价在第一方显性化，索尼取消合作近30年的小岛《PHYSINT》、王牌Insomniac《金刚狼》媒体仅78分（失眠组近十年最低），Xbox一分钟内官宣接手小岛项目反向扩张独占。任天堂两场直面会（塞尔达40周年+综合Direct 57款）内容拉满却缺世代级爆款、纯新作仅3款，叠加9/1涨价，股价连跌两天（东京-3.99%、YTD-20.71%）。Steam收入结构揭示PC"长尾长销"逻辑：2026总收入$150亿(+15%)但最卖座100款新游仅占15.9%、前6大爆款仅6.6%，约84%来自老游戏，与主机"爆款驱动"截然不同。',
    file: 'weekly/W34_20260911.html',
    tags: ['数字化系统性风险', '独占攻守易位', '任天堂资本冷淡', 'Steam长尾长销', '小岛转投Xbox'],
    highlight: true
  },
  {
    week: 'W33',
    ...
    title: '端主行业周报 W33：索尼从卖硬件到收租·GTA6拉动硬件动销·数字所有权战争升级',
    summary: '索尼公开战略换挡——社长十时裕树定调PS5已进入生命周期后半段、不再激进卖硬件，转向从1.25亿PlayStation月活收租（订阅+数字+广告，数字销售占比破82%、单用户收入较PS4世代+59%），同期PS5系统层上线FAST免费广告电视开辟第三条变现通道；但硬币另一面是第一方产能空窗——9/3 State of Play双场公布20+新作却几乎无全新第一方内容，《战神:Laufey》与《星际:异端先知》双双缺席，压轴让位给第三方FF7启示（2027/4/8）。GTA6以一段加长实机演示拉动硬件动销：直播峰值约390万创年度纪录、PS5预购单日+606%/Xbox+127%、英国主机销量涨三成、PS5 Pro全渠道缺货，Netflix美国流量+125%崩溃，R星确认首发无微交易无生成式AI。实体盘/数字所有权战争从"各走各路"升级为正面对撞：索尼诉讼中称"玩家并未真正拥有"，微软借Helix"100%实体版"传闻反攻、光盘转数字已兼容1212款。',
    file: 'weekly/W33_20260904.html',
    tags: ['索尼从卖硬件到收租', 'GTA6拉动硬件动销', '数字所有权战争升级', '第一方产能空窗', 'Xbox订阅计量化'],
    highlight: true
  },
  {
    week: 'M08',
    ...
    title: '端主行业月报 · 2026年8月',
    summary: 'Sony与Xbox在宣传口径上重新打"独占牌"，但底层发行并未真正封闭：Sony推"Only on PS5"、收缩第一方单机PC移植；Xbox停止替PS5导流，并放出《神鬼寓言》18分钟实机（2027/2/23）重建第一方内容辨识度。数字所有权走向相反路径——Sony做减法（2028停产新盘、条款重申数字仅为授权），Xbox做加法（8/31测试光盘转数字，把旧实体盘迁入账户/PC/云端），但Sharma未确认次世代Helix保留光驱。科隆游戏展定义8月产品Pipeline：17款重点产品中13款核心信息由展会释放，米哈游《源初之结》开场、《湮灭之潮》《无限大》《七日世界》等国产集体刷屏，亚洲厂商从争夺展位进入跨端发行；GTA6为展外超级变量，Netflix首播约30分钟官方演示+IGN首次媒体实机（69项细节），Newzoo判断若无GTA6，2026年主机收入基本无增长（完整游戏支出预计+17.5%）。',
    file: 'weekly/Monthly_Briefing_202608.html',
    tags: ['月报', '独占牌回归', '数字所有权分岔', '科隆游戏展Pipeline', 'GTA6市场变量', '国产3A跨端'],
    highlight: true
  },
  {
    week: 'W32',
    ...
    title: '端主行业周报 W32：国产3A集体上桌·索尼靠独占抢红利·涨价传导到需求侧',
    summary: '科隆展前宣发密集期，三款国产3A同周放出实机：《影之刃零》登上索尼专属State of Play（首个获此待遇的中国游戏）、甄子丹任创意监制、PS5主机独占一年、10/29发售，仅数字版触发海外"无光盘不购买"抵制；《黑神话:钟馗》15分钟实机B站播放破850万；《湮灭之潮》53分钟实机（腾讯投资）。索尼以"专属SoP+主机独占+第一方"明显领先微软抢占中国3A红利——第一方新IP《Marvel Tōkon》首周48.5万份、74%来自PS5。涨价潮已传导到需求侧：美国7月硬件支出创2020以来新低(-29%)、实体游戏月销1995年以来最低(Circana)，Switch2英国/爱尔兰9/1再涨价；Ampere警告PS6/Xbox Helix若$1000首发5年销量或跌40%，Valve"Steam Frame"开箱视频泄露。',
    file: 'weekly/W32_20260821.html',
    tags: ['国产3A宣发大周', 'PS5独占1年', '涨价传导需求侧', '次世代定价预警', '去实体化余波'],
    highlight: true
  },
  {
    week: 'W31',
