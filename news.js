...
// 最后更新: 2026-05-19T18:00:00Z
// 更新者: news-agent (v5.1 自动化定时更新：MCP SpreadsheetApp成功(lastRow=1356新增116行)+web_search 12轮+新增12条id259-270)
...
const newsData = [
    {
        "id": 270,
        "title": "《深海迷航2》EA首日12小时售出200万份：Steam同时在线65万，2026最快销量纪录之一",
        "summary": "Unknown Worlds开发的《Subnautica 2》于5月14日进入Steam+Xbox抢先体验，12小时内售出200万份(首小时破百万)，Steam同时在线峰值超65.1万，18000条好评。尽管此前遭遇版权纠纷风波(前工作室负责人诉讼)，游戏凭借水下生存探索的独特玩法和前作口碑取得爆发式开局。定价$29.99，成为2026年EA品类最快百万销量纪录。",
        "source": "IGN",
        ...
        "sourceUrls": [
            ...
            {"name": "Gematsu", "url": "https://www.gematsu.com/2026/05/subnautica-2-early-access-sales-top-two-million-in-12-hours"},
            {"name": "TechPowerUp", "url": "https://www.techpowerup.com/349148/subnautica-2-crosses-2-million-sales-shortly-after-launch"}
        ],
        "category": "game",
        "importance": "high",
        "featured": true,
        "date": "2026-05-15",
        "tags": ["Subnautica 2", "深海迷航", "Unknown Worlds", "Steam", "Xbox", "销量里程碑", "抢先体验"],
        "sentiment": "positive",
        "tdocMarking": "none",
        "analysis": "《深海迷航2》12小时200万份的爆发式开局验证了优质IP+差异化品类(水下生存)的市场号召力(What)。前作累计1200万+销量积累的口碑基础+Xbox Game Pass首日入库的双重曝光是核心驱动力(Why)。EA品类罕见出现如此量级首发，证明生存品类已从小众走向主流——对比帕鲁世界/V Rising的成功路径，'探索驱动型生存'正在形成可复制的爆款公式(So What)。预计首月销量将突破500万，关键在于正式版内容量能否支撑长线留存(What Next)。",
        "relatedNewsIds": [248]
    },
    {
        "id": 269,
        "title": "《极限竞速：地平线6》遭灾难性泄露：Steam预载未加密155GB文件全流出，距正式发售仍有9天",
        "summary": "5月10日，Playground Games在SteamDB上意外上传了完整未加密的《极限竞速：地平线6》游戏文件(155GB)，距5月19日正式发售仍有9天。盗版网站随即出现可下载版本，部分玩家已提前游玩。微软确认已对盗版用户实施封禁，并紧急修补Steam预载加密机制。这是2026年最大规模的3A游戏发售前泄露事件。",
        "source": "Eurogamer",
        "sourceUrl": "https://www.eurogamer.net/upcoming-video-games-2026-releases",
        "sourceUrls": [
            {"name": "17173", "url": "https://news.17173.com/content/05112026/180645819.shtml"},
            {"name": "TweakTown", "url": "https://www.tweaktown.com/news/111540/forza-horizon-6-files-reportedly-leaked-on-steam-10-days-before-release/index.html"},
            {"name": "WinBuzzer", "url": "https://winbuzzer.com/2026/05/11/microsoft-faces-forza-horizon-6-leak-as-official-launch-date-xcxwbn/"},
            {"name": "Gameluster", "url": "https://gameluster.com/forza-horizon-6-leaked-steam-update-steamdb/"},
            {"name": "TwistedVoxel", "url": "https://twistedvoxel.com/forza-horizon-6-files-reportedly-leak-through-steam-ahead-of-release/"}
        ],
        "category": "game",
        "importance": "high",
        "featured": true,
        "date": "2026-05-13",
        "tags": ["Forza Horizon 6", "极限竞速", "微软", "Steam", "泄露", "盗版", "Xbox", "Playground Games"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "analysis": "FH6未加密预载事故暴露了Steam数字发行流程中的严重安全漏洞(What)。155GB完整文件无加密上传意味着开发者侧QA流程或Steam预载配置出现重大疏忽——这不是平台问题而是发行商操作失误(Why)。对Xbox/微软而言，首发日销量和Game Pass拉新效果将受损(盗版用户不进入统计)；对行业而言，可能推动各大发行商加强Steam预载加密标准和提前审核机制(So What)。预计微软将加强与Valve的预载安全协作，后续3A发行商可能延迟预载时间窗口(What Next)。",
        "relatedNewsIds": []
    },
    {
        "id": 268,
        "title": "世嘉FY26净亏损$3160万，正式取消5年'Super Game'GaaS项目：全面转向单机大作",
        "summary": "世嘉萨米发布FY2026全年财报(2025.4-2026.3)，录得净亏损$3160万。公司正式宣布取消开发5年的'Super Game'大型在线游戏项目(原目标收入¥1000亿)，原因包括：《Sonic Rumble Party》等GaaS产品表现不佳、2023年收购Rovio计提逾$2亿减值损失。超百名F2P团队开发者将转岗至单机游戏部门。世嘉明确战略转向'非服务型游戏'(non-live-service)。",
        ...
        "sourceUrls": [
            ...
            {"name": "Niche Gamer", "url": "https://nichegamer.com/sega-cancels-billion-dollar-super-game-project/"},
            {"name": "Kantenna", "url": "https://kantenna.com/topic/sega-super-game-cancelled-gaas-strategy-shift-mainstay-ip-2026"},
            {"name": "This Week in Video Games", "url": "https://thisweekinvideogames.com/news/sega-cancels-super-game-project-pulls-back-on-free-to-play/"},
            {"name": "InGameNews", "url": "https://www.ingamenews.com/2026/05/sega-cancels-super-game-lowers-focus-on.html"}
        ],
        "category": "policy",
        "importance": "high",
        "featured": true,
        "date": "2026-05-12",
        "tags": ["世嘉", "SEGA", "Super Game", "GaaS", "战略转型", "单机", "Rovio", "财报"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "analysis": "世嘉取消Super Game是GaaS浪潮退潮的又一标志性事件——继育碧XDefiant停服、索尼Concord失败后，传统大厂正集体撤出GaaS赛道(What)。Sonic Rumble等F2P尝试的失败+Rovio$2亿减值证明：'买IP做GaaS'的模式风险极高，世嘉的核心能力在单机IP而非运营(Why)。对行业的信号：GaaS只有头部(堡垒之夜/Apex/原神)能活，中型投入的GaaS项目存活率极低；世嘉转单机=回归安全区(So What)。预计世嘉将集中资源于Persona/如龙/索尼克/全面战争等核心IP的单机大作(What Next)。",
        "relatedNewsIds": [151, 140]
    },
    {
        "id": 267,
        "title": "Xbox CEO Asha Sharma大幅重组领导层：裁撤Gaming Copilot，引入5位AI背景高管",
        "summary": "微软Xbox新任CEO Asha Sharma于5月5日发布内部备忘录，宣布Xbox部门重大人事重组：2位资深高管卸任(包括长期负责平台的VP)，引入5位具有AI/CoreAI背景的高管。同时宣布终止Gaming Copilot在移动端和主机的开发(该AI功能仅运营一年即取消)。Sharma表示重组目标是'move faster'加速项目推进。此次重组被外界解读为Xbox从内容导向转向'AI+平台'技术导向的战略信号。",
        "source": "CNBC",
        "sourceUrl": "https://www.cnbc.com/2026/05/05/microsoft-xbox-ceo-asha-sharma-executive-overhaul.html",
        "sourceUrls": [
            {"name": "CNBC", "url": "https://www.cnbc.com/2026/05/05/microsoft-xbox-ceo-asha-sharma-executive-overhaul.html"},
            {"name": "Kotaku", "url": "https://kotaku.com/new-xbox-boss-continues-big-shakeup-new-leadership-changes-2000693248"},
            {"name": "GeekWire", "url": "https://www.geekwire.com/2026/microsofts-new-xbox-chief-nixes-gaming-copilot-for-mobile-and-console-shakes-up-leadership/"},
            {"name": "GamingAmigos", "url": "https://www.gamingamigos.com/post/xbox-ceo-asha-sharma-overhauls-executive-team-with-five-new-leaders"},
            {"name": "tbreak", "url": "https://tbreak.com/xbox-asha-sharma-leadership-changes/"}
        ],
        "category": "platform",
        "importance": "high",
        "featured": true,
        "date": "2026-05-06",
        "tags": ["Xbox", "微软", "Asha Sharma", "AI", "领导层重组", "Gaming Copilot", "CoreAI"],
        "sentiment": "neutral",
        "tdocMarking": "none",
        "analysis": "Asha Sharma上任后的首次大规模重组信号明确——Xbox正从Phil Spencer时代的'内容为王'转向'AI+平台效率'路线(What)。引入5位AI/CoreAI背景高管+砍掉Gaming Copilot(短命AI产品)说明微软要的不是表面AI噱头，而是将AI深度嵌入游戏开发工具链和平台推荐系统(Why)。对Xbox生态的影响：第一方游戏交付节奏可能加快(AI辅助开发)，但创意团队自主权可能被压缩；Game Pass推荐系统可能出现AI驱动的个性化改进(So What)。关注30%利润率目标下Sharma是否会进一步裁员或关闭工作室(What Next)。",
        "relatedNewsIds": [236, 252, 251, 225]
    },
    {
        "id": 266,
        "title": "铁拳之父原田胜弘离开万代南梦宫，与SNK联合成立VS Studio新工作室",
        "summary": "经营铁拳系列逾20年的传奇制作人原田胜弘于2026年5月12日正式宣布成立新游戏开发工作室'VS Studio'。SNK(《拳皇》开发商)为该工作室提供长期投资支持并将其纳为控股子公司，但VS Studio保持创意独立。原田表示工作室秉持'挑战传统、创造新价值'理念，聚焦格斗及动作品类创新。这是近年格斗游戏界最重磅的人事变动。",
        "source": "GamesIndustry.biz",
        "sourceUrl": "https://www.gamesindustry.biz/snk-establishes-vs-studio-with-tekken-legend-katsuhiro-harada",
        "sourceUrls": [
            {"name": "Gematsu", "url": "https://www.gematsu.com/2026/05/snk-establishes-vs-studio-led-by-katsuhiro-harada"},
            {"name": "SNK官方", "url": "https://pressreleases.triplepointpr.com/2026/05/12/snk-corporation-establishes-new-game-development-studio-led-by-katsuhiro-harada/"},
            {"name": "FightersGeneration", "url": "https://www.fightersgeneration.com/news1/vs-may26.htm"},
            {"name": "新浪科技", "url": "https://finance.sina.com.cn/tech/digi/2026-05-13/doc-inhxteiq0963016.shtml"}
        ],
        "category": "policy",
        "importance": "high",
        "featured": true,
        "date": "2026-05-12",
        "tags": ["原田胜弘", "铁拳", "VS Studio", "SNK", "格斗游戏", "万代南梦宫", "工作室成立"],
        "sentiment": "positive",
        "tdocMarking": "none",
        "analysis": "铁拳之父独立创业+SNK投资控股的组合极具战略意义——这是格斗游戏产业'人才流动→新品牌诞生'趋势的缩影(What)。原田在万代南梦宫已达职业天花板(铁拳品牌难以突破格斗品类上限)，独立后可以尝试更多创新；SNK借此获得顶级制作人+潜在的铁拳vs拳皇式跨IP合作可能(Why)。对格斗游戏格局的影响：卡普空(街霸)+万代(铁拳)+Arc(罪恶装备)的三足鼎立可能被打破，VS Studio可能成为第四极(So What)。首款作品可能是新IP而非SNK既有IP的续作，关注其是否能复制铁拳的成功(What Next)。",
        "relatedNewsIds": []
    },
    {
        "id": 265,
        "title": "索尼FY25Q4财报：Bungie累计减值$7.65亿，Marathon玩家流失严重但仍获续命",
        "summary": "索尼集团发布FY2025 Q4财报(2026年1-3月)。游戏部门中，对Bungie的减值损失累计达$7.65亿(本季度新增$5.6亿)。索尼CFO在电话会议中承认Marathon的玩家留存'未达预期'(首月220万玩家热度迅速衰减)，但仍表态将继续支持Bungie进行长线运营。PS5全球累计销量达9360万台。索尼强调AI战略+TSMC合资图像传感器项目为未来增长点。",
        "source": "Kotaku",
        "sourceUrl": "https://kotaku.com/sony-records-new-560-million-loss-on-bungie-acquisition-as-marathon-struggles-and-destiny-2-nosedives-2000694100",
        "sourceUrls": [
            {"name": "Kotaku", "url": "https://kotaku.com/sony-records-new-560-million-loss-on-bungie-acquisition-as-marathon-struggles-and-destiny-2-nosedives-2000694100"},
            {"name": "SeekingAlpha", "url": "https://seekingalpha.com/article/4901274-sony-group-corporation-sony-q4-2025-earnings-call-transcript"},
            {"name": "Stockhouse", "url": "https://stockhouse.com/news/the-market-online-news/2026/05/11/sony-takes-765m-hit-on-bungie-as-marathon-struggles-to-deliver"},
            {"name": "Eastern Herald", "url": "https://easternherald.com/2026/05/09/sony-bungie-marathon-loss-playstation-crisis/"}
        ],
        "category": "policy",
        "importance": "high",
        "featured": true,
        "date": "2026-05-08",
        "tags": ["索尼", "Bungie", "Marathon", "减值", "PS5", "财报", "GaaS"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "analysis": "索尼对Bungie的$7.65亿累计减值接近收购总额($36亿)的21%，这是游戏行业GaaS投资风险的极端案例(What)。Marathon首月数据虽达220万但80%流失率说明PvP提取射击品类已极度拥挤——与Concord命运类似，缺乏差异化的GaaS很难在Fortnite/Apex/Valorant统治的市场存活(Why)。对索尼战略的影响：GaaS多元化布局受挫→可能更加依赖第一方单机独占+PS5硬件周期管理(So What)。关注索尼是否会在FY26进一步减值甚至出售Bungie——如果Marathon无法在6个月内稳定20万DAU，Bungie可能面临再次裁员(What Next)。",
        "relatedNewsIds": [260, 163, 159]
    },
    {
        "id": 264,
        "title": "Xbox探索激进方案实现30%利润率：或取消主机向后兼容、全面软件化转型",
        "summary": "已验证内部文件显示Xbox领导层正讨论多种成本削减方案以在2030年前达到微软CFO要求的30%利润率目标。方案包括：取消下一代主机的向后兼容性(削减兼容层研发成本)、将Xbox完全转为软件/服务平台(减少硬件亏损)、进一步裁减第一方工作室规模。该目标自2025年10月曝光以来已导致多轮裁员和Game Pass提价。",
        "source": "GamingBolt",
        "sourceUrl": "https://gamingbolt.com/xbox-explores-multiple-options-to-achieve-30-percent-profit-margin-by-2030",
        "sourceUrls": [
            {"name": "GamingBolt", "url": "https://gamingbolt.com/xbox-explores-multiple-options-to-achieve-30-percent-profit-margin-by-2030"},
        ...
        "featured": true,
        "date": "2026-05-06",
        "tags": ["Xbox", "微软", "利润率", "向后兼容", "软件化", "裁员", "Game Pass", "30%"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "analysis": "Xbox 30%利润率要求正在倒逼平台进行结构性变革——从硬件公司转型为纯软件/服务平台的讨论已不再是传闻而是内部正式议程(What)。微软CFO Amy Hood的财务纪律要求与游戏业务的天然低利润率(硬件补贴模式)存在根本矛盾，只有砍硬件或大幅提价才能达标(Why)。如果取消向后兼容：Xbox生态粘性将严重受损(玩家数字库无法迁移=转投PS/PC的动力)；如果全面软件化：Xbox本质变成跨平台发行商(So What)。预计2026年E3/GamesCom前后Xbox可能公布'下一代战略'，关注是否真的放弃独立硬件平台(What Next)。",
        "relatedNewsIds": [267, 252, 251, 225, 241]
    },
    {
        "id": 263,
        "title": "分析师：《GTA 6》首日需售出2500万份才算'成功'，开发预算已超$10亿",
        "summary": "彭博社报道指出Rockstar的《GTA 6》开发预算已确认突破$10亿(史上最贵游戏)。美银分析师设定的'成功'基准为首日2500万份销量；即便首日售出1000-1500万份仍可能被视为'灾难性'表现。分析师建议定价应从$70提升至$80甚至更高以匹配成本回收需求。Take-Two CEO此前已暗示'可能需要更高定价'。目前Take-Two尚未确认正式定价和具体发售日期。",
        "source": "VGC",
        "sourceUrl": "https://www.videogameschronicle.com/news/gta-6-needs-25m-day-one-sales-analyst/",
        "sourceUrls": [
            {"name": "IT之家", "url": "https://www.ithome.com/0/867/812.htm"},
            {"name": "VGC", "url": "https://www.videogameschronicle.com/news/gta-6-needs-25m-day-one-sales-analyst/"},
            {"name": "GamingBolt", "url": "https://gamingbolt.com/gta-6-analyst-estimates-first-day-25-million-sales-needed"}
        ],
        "category": "game",
        "importance": "high",
        "featured": true,
        "date": "2026-05-06",
        "tags": ["GTA 6", "Take-Two", "Rockstar", "开发预算", "定价", "销量预期", "彭博社"],
        "sentiment": "neutral",
        "tdocMarking": "none",
        "analysis": "GTA 6的$10亿+开发预算标志着3A游戏研发成本已进入'好莱坞大片化'的不可逆轨道——风险集中度极高，容错空间接近于零(What)。分析师设定2500万首日的'成功线'意味着GTA 6需要超越历史上所有游戏的首发记录(GTA V首日1100万/前三天$10亿)才算及格(Why)。对行业定价的连锁影响：如GTA 6定价$80+获得市场接受，将为全行业3A涨价打开大门(So What)。Take-Two的定价决策可能推迟到发售前2-3个月公布，$70-$100区间取决于包含内容量和版本策略(What Next)。",
        "relatedNewsIds": [257]
    },
    {
        "id": 262,
        "title": "Xbox PC应用代码泄露'Project Saluki'：Game Pass或将进入中国市场",
        "summary": "Windows Central报道，Xbox PC应用最新Insider版本代码中发现'Project Saluki'代号，指向Game Pass订阅服务的中国市场本地化适配(受限内容库+本地支付整合)。同时发现'Project Positron'项目疑涉实体游戏碟转数字许可证功能。两个项目均未获微软官方确认。如Game Pass真正入华，将是Xbox自2014年Xbox One入华失败后的再次尝试。",
        "source": "Windows Central",
        "sourceUrl": "https://www.windowscentral.com/gaming/xbox/project-saluki-a-new-xbox-game-pass-tier-has-been-unearthed-alongside-a-curious-positron-disc-to-digital-program-and-it-could-be-huge",
        "sourceUrls": [
            {"name": "Windows Central", "url": "https://www.windowscentral.com/gaming/xbox/project-saluki-a-new-xbox-game-pass-tier-has-been-unearthed-alongside-a-curious-positron-disc-to-digital-program-and-it-could-be-huge"},
            {"name": "IC工作", "url": "https://www.ic.work/article/xbox-pc-app-project-saluki-game-pass-china-expansion"}
        ],
        "category": "platform",
        "importance": "medium",
        "featured": true,
        "date": "2026-05-13",
        "tags": ["Xbox", "Game Pass", "中国市场", "Project Saluki", "微软", "订阅服务"],
        "sentiment": "neutral",
        "tdocMarking": "none",
    ...
    {
        "id": 261,
        "title": "《怪物猎人：荒野》FY26全年仅售132万份，不及前作《崛起》表现",
        "summary": "卡普空FY2026全年财报显示《怪物猎人：荒野》在本财年(2025.4-2026.3)仅售出132万份，低于同期《崛起》的151万和《曙光》DLC的142万。尽管游戏发售初期口碑良好，但后续内容更新节奏偏慢导致热度下滑。卡普空将寄望于即将推出的大型DLC(G位扩展)来挽救销量颓势。",
        "source": "3DM",
        "sourceUrl": "https://www.3dmgame.com/news/202605/4095822.html",
        "sourceUrls": [
            {"name": "3DM", "url": "https://www.3dmgame.com/news/202605/4095822.html"}
        ],
        "category": "game",
        "importance": "medium",
        "featured": true,
        "date": "2026-05-14",
        "tags": ["怪物猎人", "荒野", "卡普空", "Capcom", "销量", "财报"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "relatedNewsIds": []
    },
    {
        "id": 260,
        "title": "《失落星船：马拉松》首月220万玩家但流失率达80%：Bungie坚持长线运营",
        "summary": "Bungie的PvP提取射击游戏《Marathon》首月吸引220万玩家(PS5约66万/Xbox约52.5万/PC约110万)，但活跃度已跌出热度排行前100，约80%玩家流失。尽管数据不理想，Bungie仍表示已规划未来数年叙事和内容路线图，将坚持长线运营策略。索尼在财报中承认Marathon'未达预期'。",
        "source": "IT之家",
        "sourceUrl": "https://www.ithome.com/0/867/785.htm",
        "sourceUrls": [
            {"name": "IT之家", "url": "https://www.ithome.com/0/867/785.htm"},
            {"name": "Eurogamer", "url": "https://www.eurogamer.net/marathon-player-retention-concerns"},
            {"name": "GamingBolt", "url": "https://gamingbolt.com/marathon-player-count-drops-80-percent-first-month"}
        ],
        "category": "game",
        "importance": "medium",
        "featured": true,
        "date": "2026-05-02",
        "tags": ["Marathon", "Bungie", "索尼", "GaaS", "玩家流失", "PvP"],
        "sentiment": "negative",
        "tdocMarking": "none",
        "relatedNewsIds": [265, 163, 159]
    },
    {
        "id": 259,
        "title": "Griffin Gaming Partners推出$1亿独立游戏基金：收入分成模式取代传统股权投资",
        "summary": "游戏投资机构Griffin Gaming Partners宣布设立名为'Special Opportunities Fund'的$1亿独立游戏专项基金，由Hooded Horse CEO Tim Bender领导。该基金采用创新的收入分成模式(revenue share)而非传统股权投资，旨在为中小独立工作室提供开发资金同时保障其创意独立性和股权完整。这是2026年游戏行业最大的独立游戏专项投资。",
        "source": "GamesIndustry.biz",
        "sourceUrl": "https://www.gamesindustry.biz/griffin-gaming-partners-launches-100m-indie-fund",
        "sourceUrls": [
            {"name": "GamesIndustry.biz", "url": "https://www.gamesindustry.biz/griffin-gaming-partners-launches-100m-indie-fund"}
        ],
        "category": "policy",
        "importance": "medium",
        "featured": true,
        "date": "2026-05-08",
        "tags": ["Griffin Gaming", "独立游戏", "投资", "收入分成", "Hooded Horse", "基金"],
        "sentiment": "positive",
        "tdocMarking": "none",
        "relatedNewsIds": [238]
    },
